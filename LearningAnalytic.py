...
print("data_sample_name: ",data_sample_name)
...
print("data_sample_Ramses: ",data_sample_Ramses)
...
data_sample.sampleWrite("Sample.txt")

#create a new csv file and write a sample in
data_sample.sampleCsvWrite("Sample.csv")
